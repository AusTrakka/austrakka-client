...
import PublicHealthDefaultDashboard from '../components/Dashboards/Templates/DefaultDashboard';
...
import DefaultDashboard from '../components/Dashboards/Templates/BasicDashboard';
