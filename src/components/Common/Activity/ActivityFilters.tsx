  ...
  return (
    <Box sx={{ minWidth: 170, maxWidth: 180, flex: 1 }}>
      <DatePicker
        ...
        onChange={(newValue) => {
          onChange(newValue ? calculateDateValue(newValue.toDate()) : null);
        }}
        slotProps={{
          textField: {
            fullWidth: true,
              ...
              .map((column) => {
                ...
                return (
                  <Box
                    ...
                    sx={{ minWidth: 170, maxWidth: 180, flex: '1 1 180px' }}
                  >
                    <FilterTextInput
                      label={column.headerName}
                      value={value}
                      onChange={(val) =>
                        handleFilterChange(column.columnName as keyof Filters, val)
                      }
