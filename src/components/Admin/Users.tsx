...
import { type DataTableRowClickEvent, DataTable, type DataTableFilterMetaData, type DataTableFilterMeta } from 'primereact/datatable';
...
function Users() {
  ...
  const columns = [
    ...
    { field: 'lastLogIn', header: 'Last Log In', body: (rowData: any) => isoDateOrNotRecorded(rowData.lastLogIn) },
    { field: 'lastActive', header: 'Last Active', body: (rowData: any) => isoDateOrNotRecorded(rowData.lastActive) },
  ];
