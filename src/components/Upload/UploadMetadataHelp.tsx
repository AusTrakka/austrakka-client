...
export default function UploadMetadataHelp() {
  return (
    <>
      ...
      <br />
      Metadata can be submitted in tabular format, either in CSV or Excel (xlsx) format. Files
      should have extensions
      <code> .csv </code>
      or
      <code> .xlsx</code>. If not using the proforma directly, ensure that column names in your CSV
      or Excel file match those in the proforma.
      <br />
      <br />
      ...
      The first row of the spreadsheet is considered to be the header row. When using an Excel
      proforma the first worksheet will be used as the sample metadata table.
    </>
  );
}
