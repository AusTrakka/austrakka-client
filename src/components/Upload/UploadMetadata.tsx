...
const uploadOptions = [
  {
    ...
    label: 'Validate only',
    description:
      'Do not upload metadata, just see validation errors and warnings. This is not a full dry run: it will validate correctness of data against allowed values and types, but will not give a preview of data changes.',
  },
  {
    name: 'blank',
  ...
  },
  {
    ...
    description:
      'Add or update metadata for existing samples only; do not create new samples. Will check that all Seq_IDs in the upload are known.',
  },
];
    ...
    <>
      ...
      >
        ...
        <Grid size={{ md: 12, lg: 9 }}>
          <Typography variant="subtitle2" paddingBottom={1}>
            Please select a proforma for validation, and select a metadata file to upload. Metadata
            can be submitted in tabular format, either in CSV or Excel (xlsx) format.
            <br />
      ...
      >
        <Grid container spacing={2} direction="column" alignItems="center" justifyContent="center">
          <Grid>
            <Typography>
              {options.validate ? 'Validating metadata... ' : 'Uploading metadata... '}
            </Typography>
          </Grid>
          <Grid>
