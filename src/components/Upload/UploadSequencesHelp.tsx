  ...
  return (
    <>
      ...
      <Typography variant="body1" color="textPrimary" paddingBottom={2}>
        ...
        its <InlineCode>Seq_ID</InlineCode> will be taken from the header, not the filename.
      </Typography>
      ...
      <ul>
        <li>
          <InlineCode>Skip</InlineCode> will silently ignore any <InlineCode>Seq_ID</InlineCode>{' '}
