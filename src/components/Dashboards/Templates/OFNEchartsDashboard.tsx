...
import MetadataValueBarEchart from '../../Widgets/ProjectWidgets/EChartsWidgets/MetadataValueBarEchart';
        ...
        <Grid size={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 4 }}>
          ...
          >
            ...
            >
              ...
              <Grid container spacing={2} size={12}>
                <Grid size={{ sm: 12, md: 12, lg: 7, xl: 7 }}>
                  <Counts
                    projectAbbrev={projectAbbrev}
                    filteredData={filteredData}
                    timeFilterObject={timeFilterObject}
                ...
                <Grid size={{ sm: 12, md: 12, lg: 5, xl: 5 }}>
                  <MetadataValueBarEchart
                    widgetType={WidgetType.Project}
                    identifier={projectAbbrev}
                    filteredData={filteredData}
