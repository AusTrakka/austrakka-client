...
describe('formatDate', () => {
  ...
  describe('when given the current date', () => {
    test('returns a formatted string with day, date, month, year, time, and timezone', () => {
  ...
  describe('when given different times of day', () => {
    test('correctly formats morning and evening times', () => {
  ...
  describe('when given a date from a different year', () => {
    test('formats the date with the correct year and handles year-end scenarios', () => {
